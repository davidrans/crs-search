    ...
    for p in soup.find_all("p"):
            ...
            if current_section_id:
                ...
                if full_content:
                    sections_data.append(
                        (main_title, current_article, current_section_id, full_content)
                    )
        ...
        # C. Continuation of Current Section
            ...
            if (
                ...
                or text.startswith("Cross references:")
                or text.startswith("Law reviews:")
            ):
                continue
...
def run_indexing():
    ...
    print("Parsing HTML...")
    # CALL THE PARSER
    all_sections = parse_crs_html(
        r"C:\Users\drans\Desktop\Colorado Revised Statutes 2024 Title 18 Criminal Code.html"
    )
